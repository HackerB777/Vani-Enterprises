        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input id={`${uid}-name`} required type="text" value={form.name} onChange={(e) => set('name', e.target.value)}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id={`${uid}-slug`} required type="text" value={form.slug} onChange={(e) => set('slug', e.target.value)}
