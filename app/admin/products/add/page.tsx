...
}: { value: string; index: number; onChange: (v: string) => void; onRemove: () => void }) {
  return (
    <div className="flex items-center gap-2">
      <span className="flex-shrink-0 h-5 w-5 rounded-full bg-stone-100 text-[10px] font-bold text-stone-400 flex items-center justify-center">
        {index + 1}
      </span>
      <input
        type="text"
        ...
        placeholder={['Material: 100% Cotton', 'Origin: Kanchipuram', 'Care: Machine wash cold', 'Weight: 450g'][index % 4]}
      ...
      <button
        type="button"
        onClick={onRemove}
        className="flex-shrink-0 rounded-lg p-1.5 text-stone-300 hover:bg-red-50 hover:text-red-400 transition"
        aria-label="Remove"
      >
    ...
    <div className="p-6 lg:p-8 max-w-4xl space-y-6">
      ...
      {saved && (
        <div className="flex items-center gap-2 rounded-xl bg-green-50 border border-green-200 px-4 py-3 text-sm font-medium text-green-700">
          ...
          Product saved! (UI demo — connect a database to persist)
        </div>
      )}
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-stone-400 mt-0.5">Upload up to 8 images. Drag to reorder. Click to set primary.</p>
            </div>
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-1 text-[11px] text-stone-400">Auto-generated from name. Edit to customise.</p>
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="A short, compelling summary shown on product cards and search results."
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="A detailed description of the product — craftsmanship, materials, usage, and what makes it special. This is shown on the product page."
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-[11px] text-stone-400 mt-0.5">Displayed as a bullet list on the product page.</p>
              </div>
              <button
                type="button"
                onClick={addDetail}
                disabled={details.length >= 12}
            ...
            <div className="rounded-xl bg-stone-50 border border-stone-100 px-4 py-3 flex flex-wrap gap-4 text-sm">
              ...
              {origPrice > price && (
                <>
                  ...
                  <div>
                    <p className="text-xs text-stone-400 mb-0.5">You Save</p>
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <label
                key={key}
                className={`flex cursor-pointer flex-col gap-1 rounded-xl border px-3 py-3 transition ${
